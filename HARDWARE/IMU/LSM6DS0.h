...
#define LSM6DS3_ACC_GYRO_FIFO_CTRL1  	0X07  //fifo水印阈值
#define LSM6DS3_ACC_GYRO_FIFO_CTRL2  	0X08  //
#define LSM6DS3_ACC_GYRO_FIFO_CTRL3  	0X09
#define LSM6DS3_ACC_GYRO_FIFO_CTRL4  	0X0A

//#define LSM6DS3_ACC_GYRO_ORIENT_CFG_G  	0X0B

#define LSM6DS3_ACC_GYRO_INT1_CTRL  	0X0D  //INT1脚控制寄存器
#define LSM6DS3_ACC_GYRO_INT2_CTRL  	0X0E  //INT2脚控制寄存器，INT2_DRDY_G INT2_DRDY_XL 角速度和加速度中断在INT2脚
#define LSM6DS3_ACC_GYRO_WHO_AM_I_REG  	0X0F //6CH
#define LSM6DS3_ACC_GYRO_CTRL1_XL  	0X10  //加速度控制寄存器 采集速率和量程  
//0101xxxx 208HZ XL_HM_MODE=1 CTRL6_C(15H)  xxxx01xx 16g XL_FS_MODE=0 CTRL8_XL(17H)
#define LSM6DS3_ACC_GYRO_CTRL2_G  	0X11  //角速度控制寄存器 采集速度和量程  
...
#define LSM6DS3_ACC_GYRO_TIMESTAMP2_REG  	0X42  //时间戳第一数据输出寄存器
