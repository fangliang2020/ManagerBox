...
/**
  * @brief  Initializes the W25Q64FV interface.
  * @retval None
  */
...
/**
  * @brief  Reads current status of the W25Q64FV.
  * @retval W25Q64FV memory status
  */
